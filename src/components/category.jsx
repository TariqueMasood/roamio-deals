                ...
                <div css={categoriesContainer}>
                    {
                        categoriesData.map((category, index) => {
                            return (
                                <Category key={index} anchorLink={category.anchorLink} image={category.image} text={category.text} />
                            )
                        })
                    }
                    <a href="#" css={viewAllLinkCss}>
                        <img src={category8} css={viewAllImageCss} alt="img" />
                        <div css={viewAllTextCss}>View All <img src={chevronIcon} alt="" /> </div>
                    </a>
                </div>
            </div>
        </section>
